  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="flex justify-between items-center h-16 w-full">
            ...
            {!user && (
              <Link
                href="/login"
                className="px-4 py-2 bg-[#DC143C] text-white rounded-lg hover:bg-[#B8122E] transition-colors font-semibold"
              >
                Login
              </Link>
            )}
      ...
      {user && (
        <Link
          href="/create"
          className={`fixed bottom-6 right-6 z-50 bg-[#DC143C] text-white rounded-full p-4 shadow-lg hover:bg-[#B8122E] transition-all hover:scale-110 ${
            isActive("/create") ? "ring-4 ring-red-200" : ""
          }`}
          title="Create Post"
        >
